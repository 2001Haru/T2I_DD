...
SPARSE_SEED0_BANK="${SPARSE_SEED0_BANK:-$OLD_SPARSE_ROOT/caption_banks/bank_seed_0/m_4.json}"
SPARSE_SEED1_BANK="${SPARSE_SEED1_BANK:-$SPARSE_GENERALITY_ROOT/nette/train_seed_1/caption_banks/bank_seed_0/m_4.json}"
...
python "$EXPERIMENT_DIR/run_sparse_interface_transfer.py" \
  ...
  --prototype "$PROTOTYPE" --dcs "$DCS" \
  --sparse-seed0-bank "$SPARSE_SEED0_BANK" --sparse-seed1-bank "$SPARSE_SEED1_BANK" \
