...
HISTORICAL_STRENGTH_INDEX="${HISTORICAL_STRENGTH_INDEX:-./strength_prompt_interaction_runs/strength_prompt_interaction_v0/evaluation_index.json}"
GPUS="${GPUS:-0,1,2,3}"
...
python experiments/text_supervision_factorial/run_label_length_protocol.py \
  ...
  --historical-strength-index "$HISTORICAL_STRENGTH_INDEX"
